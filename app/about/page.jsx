const About = () => {
  return (
    <section className="p-2">
      ...
      <hr />
      <h2 className="text-2xl mt-4 mb-3 font-bold">The Beginning</h2>
      <p className="indent-5 mb-2 ml-1">
      ...
      <h2 className="text-2xl mt-4 mb-3 font-bold">Intuition</h2>
      <p className="indent-5 mb-2">
      ...
      <p className="indent-5 mb-2">He does just that...</p>
      <h2 className="text-2xl mt-4 mb-3 font-bold">The Future</h2>
      <p className="indent-5 mb-2">
